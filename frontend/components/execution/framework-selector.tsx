          ...
          <p className="text-xs text-amber-600 bg-amber-50 border border-amber-200 rounded px-2 py-1">
            {
              {
                agent_orchestrator:
                  "Erwartete Laufzeit: 5–10 Min. (60–75 sequenzielle LLM-Calls pro Dokument)",
                agent_multi:
                  "Erwartete Laufzeit: 3–6 Min. (keine Retry-Koordination zwischen Agenten)",
                hybrid_agent:
                  "Erwartete Laufzeit: 3–5 Min. (Agent nur in Phase 2, Pre/Post deterministisch)",
