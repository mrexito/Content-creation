...
**Datum:** 2026-03-16 15:31:13  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 1
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 10.9 | 100% | – | – |
| LangGraph | Node → StateGraph → Node | 18.2 | 100% | – | – |
| Hybrid | LC → LangGraph → LC | 13.1 | 100% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 10.9 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 18.2 | mistral | – | – | – |
| Hybrid | 5 | 4 / 4 | 100% | 13.1 | mistral | – | – | – |
...
```
Löse die Gleichung $6a - 8 = 2$, wobei $a$ eine Variable ist.
```
</details>
...
```
Aufgabe 3: Ermittle die Länge des Kreisumfangs eines Polygons, wenn dessen Seitenlängen 6 Meter, 8 Meter und 10 Meter betragen.
```
</details>
...
```
Berechne die Länge der Begrenzung eines Dreiecks, wenn die Seitenlängen gegeben sind als $p = 5$, $q = 7$ und $r = 9$.
```
</details>
...
```
Berechne den Umfang eines Dreiecks, dessen Seitenlängen die folgenden sind: $p = 12$ Meter, $q = 15$ Meter und $r = 18$ Meter.
```
</details>
...
```
Aufgabe 4: Eine Investition von 1500 € wird mit einem Zinssatz von 2,5 % für ein Jahr angelegt. Ermitteln Sie das Kapital am Ende der Einlagezeit.
```
</details>
...
```
Aufgabe 4: Eine Investition von 1500 Dollar wird zu 6,5 % annualer Zinsen verzinst. Ermitteln Sie das Ergebnis-Gesamt nach 8 Jahren.
```
</details>
...
```
Aufgabe 4: Angenommen, ein Anfangsbetrag von 1500 Euro soll zu einer Rendite von 2,5 Prozent pro Jahr ansteigen, berechnen Sie das Kapital nach sieben Jahren.
```
</details>
