...
**Datum:** 2026-04-20 23:00:20  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 157.1 | 83% | – | – |
| LangGraph | Node → StateGraph → Node | 504.8 | 83% | 3.1 | – |
| Hybrid | LC → LangGraph → LC | 290.0 | 85% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 66.4 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 231.2 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 108.7 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 58.7 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 310.1 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 245.4 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 132.2 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 115.9 | mistral | – | 0 | – |
| Hybrid | 5 | 4 / 4 | 100% | 252.4 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 143.3 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 507.5 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 277.6 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 143.2 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 603.9 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 410.9 | mistral | – | – | – |
...
```
Aufgabe 1: Löse die Gleichung: $3a + 8 = 17$
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 80.4 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 284.9 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 143.5 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 166.7 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 395.6 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 200.8 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 208.7 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 635.2 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 281.4 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 168.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 347.7 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 242.5 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 169.5 | tesseract | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 615.0 | tesseract | – | 5 | – |
| Hybrid | 4 | 3 / 4 | 75% | 218.4 | tesseract | – | – | – |
...
__ Gebäude thront auf __ Anhöhe.
...
__ Schloss thront auf __ Plateau.  
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 1 / 3 | 33% | 118.9 | tesseract | – | – | – |
| LangGraph | 4 | 2 / 3 | 67% | 487.3 | tesseract | – | 3 | – |
| Hybrid | 4 | 2 / 3 | 67% | 207.9 | tesseract | – | – | – |

**PDF:** `income_statement.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 196.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 582.3 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 389.1 | tesseract | – | – | – |

**PDF:** `investment_calculation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 2 / 4 | 50% | 196.7 | tesseract | – | – | – |
| LangGraph | 5 | 1 / 4 | 25% | 601.0 | tesseract | – | 3 | – |
| Hybrid | 5 | 1 / 3 | 33% | 416.8 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 282.0 | tesseract | – | – | – |
| LangGraph | 6 | 2 / 5 | 40% | 1151.4 | tesseract | – | 6 | – |
| Hybrid | 6 | 3 / 5 | 60% | 453.4 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 225.7 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 702.2 | tesseract | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 501.4 | tesseract | – | – | – |
...
- Eigenkapitalanteil: 170.000 CHF  
- Fremdkapitalbestand: 150.000 CHF  
...
```
Der Jahresbilanzwert der Beispiel GmbH beträgt 260 000 CHF, das Eigenkapital liegt bei 78 000 CHF. Bestimme den Eigenkapitalanteil am Gesamtvermögen.
```
...
```
Der Jahreserlös der Nordwind GmbH betrug 780.000 CHF, die Betriebsausgaben lagen bei 610.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Aufgabe 2: Der Umsatz betrug 650 000 € und die Kosten 300 000 €.  
Wie hoch ist der Gewinn?
```
</details>
...
- **LangGraph** / economics / Seg 4 / V1: Ratio 3.2×
- **Hybrid** / economics / Seg 4 / V1: Ratio 3.2×
- **LangGraph** / economics / Seg 3 / V1: Ratio 4.8×
- **LangGraph** / economics / Seg 4 / V1: Ratio 4.4×
