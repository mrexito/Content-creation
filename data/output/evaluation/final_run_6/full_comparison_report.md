...
**Datum:** 2026-04-20 20:32:12  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 66.5 | 86% | – | – |
| LangGraph | Node → StateGraph → Node | 209.6 | 86% | 3.4 | – |
| Hybrid | LC → LangGraph → LC | 118.8 | 86% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 70.2 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 218.3 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 117.9 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 63.5 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 187.7 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 129.4 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 65.5 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 57.0 | mistral | – | 0 | – |
| Hybrid | 4 | 4 / 4 | 100% | 60.8 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 72.4 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 233.7 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 149.7 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 78.3 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 202.2 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 117.9 | mistral | – | – | – |
...
```
Aufgabe 4: Ein Kapital von 1300 € wird zu 4 % Zinsen angelegt. Wie hoch ist das Endkapital nach 7 Jahren?
```
</details>
...
```
Ein Anfangskapital von 1 400 CHF wird zu einem Zinssatz von 4,5 % angelegt.  
Wie groß ist das Endkapital nach 7 Jahren?
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 32.5 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 94.7 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 51.0 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 55.8 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 145.6 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 65.9 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 97.5 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 229.0 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 114.7 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 58.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 156.2 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 89.8 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 4 | 75% | 52.8 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 146.9 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 87.2 | tesseract | – | – | – |
...
__ Schloss thront über __ Anhöhe.
__ Schüler tollen sich in __ Park.
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 49.2 | tesseract | – | – | – |
| LangGraph | 4 | 2 / 3 | 67% | 296.7 | tesseract | – | 7 | – |
| Hybrid | – | – | – | – | – | – | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 70.3 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 204.7 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 141.0 | tesseract | – | – | – |

**PDF:** `investment_calculation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 2 / 4 | 50% | 77.9 | tesseract | – | – | – |
| LangGraph | 5 | 1 / 4 | 25% | 292.1 | tesseract | – | 4 | – |
| Hybrid | 5 | 1 / 4 | 25% | 183.7 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 73.8 | tesseract | – | – | – |
| LangGraph | 6 | 3 / 5 | 60% | 406.7 | tesseract | – | 6 | – |
| Hybrid | 6 | 2 / 5 | 40% | 189.6 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 79.4 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 272.5 | tesseract | – | 4 | – |
| Hybrid | 6 | 4 / 5 | 80% | 165.3 | tesseract | – | – | – |
...
```
Der Eigenkapitalanteil beträgt 210 000 CHF, das Gesamtkapital 560 000 CHF. Ermittele den Eigenkapitalanteil am Gesamtkapital.
```
</details>
...
```
Die AlphaTech AG weist ein Eigenkapital von 190 000 CHF und ein Gesamtkapital von 820 000 CHF aus. Bestimmen Sie den Eigenkapitalanteil am Gesamtkapital.
```

> **Issues:** Semantische Ähnlichkeit zu gering (Wirtschaft): BERTScore 0.715 < 0.72 | Länge weicht stark ab: 153 vs 42 Zeichen (Ratio: 3.64, erlaubt: 0.3–3.5)
</details>
...
```
Der Jahreserlös der BeispielTech GmbH betrug 770.000 CHF, die Betriebsausgaben lagen bei 310.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der Beispiel GmbH beträgt 680.000 CHF, die Betriebsausgaben liegen bei 620.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
- **LangGraph** / economics / Seg 3 / V1: Ratio 3.6×
- **LangChain** / economics / Seg 3 / V1: Ratio 3.1×
- **LangGraph** / economics / Seg 3 / V1: Ratio 3.1×
- **LangGraph** / economics / Seg 3 / V1: Ratio 5.6×
