...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 147.7 | 83% | – | – |
| LangGraph | Node → StateGraph → Node | 353.7 | 96% | 3.0 | – |
| Hybrid | LC → LangGraph → LC | 269.5 | 87% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 208.9 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 530.4 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 371.1 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 170.7 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 404.1 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 270.9 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 107.3 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 109.8 | mistral | – | 0 | – |
| Hybrid | 4 | 4 / 4 | 100% | 224.9 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 151.2 | mistral | – | – | – |
| LangGraph | – | – | – | – | – | – | – | – |
| Hybrid | 6 | 4 / 5 | 80% | 530.7 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 270.3 | mistral | – | – | – |
| LangGraph | – | – | – | – | – | – | – | – |
| Hybrid | 6 | 5 / 5 | 100% | 370.8 | mistral | – | – | – |
...
```
Aufgabe 1: Löse die Gleichung: $3x + 8 = 18$
```
</details>
...
```
Aufgabe 2: Vereinfache: $5(x + 4) - 5(x - 3)$
```
</details>
...
```
Aufgabe 4: Ein Kapital von 1350 € wird zu 2 % Zinsen angelegt.  
Wie hoch ist das Endkapital nach 7 Jahren?
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 64.1 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 202.9 | tesseract | – | 4 | – |
| Hybrid | 4 | 3 / 3 | 100% | 100.8 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 128.5 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 303.2 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 138.9 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 151.4 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 406.1 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 196.7 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 109.7 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 411.4 | tesseract | – | 4 | – |
| Hybrid | 5 | 4 / 4 | 100% | 187.9 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 4 | 75% | 127.4 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 268.7 | tesseract | – | 3 | – |
| Hybrid | 4 | 4 / 4 | 100% | 77.3 | tesseract | – | – | – |
...
Ich laufe zur Hochschule. —
Er studiert ein Magazin. —
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 82.9 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 390.6 | tesseract | – | 4 | – |
| Hybrid | – | – | – | – | – | – | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 127.5 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 468.8 | tesseract | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 283.2 | tesseract | – | – | – |

**PDF:** `investment_calculation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 2 / 4 | 50% | 165.6 | tesseract | – | – | – |
| LangGraph | – | – | – | – | – | – | – | – |
| Hybrid | 5 | 2 / 4 | 50% | 288.5 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 2 / 5 | 40% | 167.2 | tesseract | – | – | – |
| LangGraph | – | – | – | – | – | – | – | – |
| Hybrid | 6 | 2 / 5 | 40% | 397.2 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 183.0 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 395.2 | tesseract | – | 3 | – |
| Hybrid | 6 | 4 / 4 | 100% | 333.8 | tesseract | – | – | – |
...
```
Ermittle den Eigenkapitalanteil der Nova AG, wenn das Eigenkapital 1,300 000 CHF und das Gesamtkapital 4,200 000 CHF beträgt.
```
</details>
...
```
Ermittle den Eigenkapitalanteil, wenn das Eigenkapital einer fiktiven Firma 1 300 000 CHF und das Gesamtkapital 2 600 000 CHF beträgt.
```
</details>
...
```
Der Jahreserlös der Nordwind GmbH betrug 730 000 CHF, die Betriebsausgaben lagen bei 640 000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der Nordwind GmbH betrug 720 000 CHF, die Betriebsausgaben lagen bei 540 000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
