...
**Datum:** 2026-04-20 13:36:03  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 1
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 64.7 | 91% | – | – |
| LangGraph | Node → StateGraph → Node | 167.8 | 91% | 2.4 | – |
| Hybrid | LC → LangGraph → LC | 127.2 | 91% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 64.8 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 178.3 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 108.9 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 54.5 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 184.3 | mistral | – | 3 | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 62.3 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 64.2 | mistral | – | 0 | – |
| Hybrid | 5 | 4 / 4 | 100% | 134.3 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 68.8 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 206.3 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 145.2 | mistral | – | – | – |
...
| LangGraph | 6 | 5 / 5 | 100% | 205.8 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 132.5 | mistral | – | – | – |
