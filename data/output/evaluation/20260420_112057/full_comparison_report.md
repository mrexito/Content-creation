...
**Datum:** 2026-04-20 11:20:57  |  **Varianten/Segment:** 1  |  **Frameworks:** 1  |  **Domains:** 1
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 67.1 | 90% | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 68.5 | mistral | – | – | – |
...
1. **LangChain** erzielte in der Domain *math* die höchste Validation-Rate (100%).
