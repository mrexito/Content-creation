...
**Datum:** 2026-04-22 00:35:01  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 70.1 | 87% | – | – |
| LangGraph | Node → StateGraph → Node | 209.0 | 86% | 3.3 | – |
| Hybrid | LC → LangGraph → LC | 119.2 | 87% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 68.1 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 189.3 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 127.2 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 68.1 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 197.8 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 115.3 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 65.6 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 56.0 | mistral | – | 0 | – |
| Hybrid | 4 | 4 / 4 | 100% | 55.3 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 66.0 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 256.8 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 189.7 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 100.5 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 183.3 | mistral | – | 3 | – |
...
```
Aufgabe 1: Löse die Gleichung: $4a \,+\, 8 \;=\; 18$
```
</details>
...
```
Aufgabe 2: Vereinfache: $2\bigl(x + 3\bigr) \;-\; 3\bigl(x - 2\bigr)$
```
</details>
...
```
Aufgabe 4: Ein Kapital von 1400 € wird zu 5 % Zinsen angelegt.  
...
```
Aufgabe 4: Ein Kapital von 1400 € wird zu 4 % Zinsen angelegt. Wie hoch ist das Endkapital nach 7 Jahren?
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 35.6 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 86.7 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 54.2 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 44.4 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 143.6 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 85.5 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 101.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 224.2 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 114.5 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 62.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 185.1 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 93.1 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 55.4 | tesseract | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 142.8 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 4 | 75% | 89.6 | tesseract | – | – | – |
...
__ Bauernhof liegt auf __ Anhöhe.
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 60.1 | tesseract | – | – | – |
| LangGraph | 4 | 2 / 3 | 67% | 239.7 | tesseract | – | 6 | – |
| Hybrid | 4 | 3 / 3 | 100% | 88.9 | tesseract | – | – | – |

**PDF:** `income_statement.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 73.4 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 257.9 | tesseract | – | 4 | – |
| Hybrid | 5 | 3 / 4 | 75% | 135.4 | tesseract | – | – | – |

**PDF:** `investment_calculation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 1 / 4 | 25% | 76.2 | tesseract | – | – | – |
| LangGraph | 6 | 2 / 4 | 50% | 369.9 | tesseract | – | 5 | – |
| Hybrid | 5 | 2 / 3 | 67% | 223.0 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 91.8 | tesseract | – | – | – |
| LangGraph | 6 | 3 / 5 | 60% | 369.3 | tesseract | – | 5 | – |
| Hybrid | 6 | 2 / 4 | 50% | 151.8 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 82.6 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 232.1 | tesseract | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 145.0 | tesseract | – | – | – |
...
**PASSIVA**  
- Eigenkapitalanteil: 78.000 CHF  
- Fremdkapitalquote: 240.000 CHF  
...
```
Bestimme den Eigenkapitalanteil, wenn das Eigenkapital 140 000 CHF und das Gesamtkapital 350 000 CHF betragen.
```
</details>
...
```
Die NovaFin AG hat ein Eigenkapital von 1 300 000 CHF und ein Gesamtkapital von 2 600 000 CHF. Ermitteln Sie den Eigenkapitalanteil am Gesamtkapital.
```

> **Issues:** Semantische Ähnlichkeit zu gering (Wirtschaft): BERTScore 0.716 < 0.72 | Länge weicht stark ab: 149 vs 42 Zeichen (Ratio: 3.55, erlaubt: 0.3–3.5)
</details>
...
```
Der Jahreserlös der AlpineTech GmbH betrug 680 000 CHF, die Betriebskosten 620 000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der Nordwest GmbH betrug 720 000 CHF, die Betriebsausgaben lagen bei 590 000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Aufgabe 2: Der Umsatz betrug 650.000 € die Kosten 600.000 €
Wie hoch ist der Gewinn?
```
</details>
...
- **LangChain** / economics / Seg 4 / V1: Ratio 3.1×
- **LangGraph** / economics / Seg 4 / V1: Ratio 3.1×
- **Hybrid** / economics / Seg 3 / V1: Ratio 3.0×
- **Hybrid** / economics / Seg 4 / V1: Ratio 3.4×
- **LangChain** / economics / Seg 3 / V1: Ratio 3.6×
- **LangChain** / economics / Seg 4 / V1: Ratio 6.5×
- **LangChain** / economics / Seg 5 / V1: Ratio 3.4×
- **LangGraph** / economics / Seg 5 / V1: Ratio 3.2×
- **LangGraph** / economics / Seg 6 / V1: Ratio 3.5×
