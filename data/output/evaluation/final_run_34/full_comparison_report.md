...
**Datum:** 2026-04-22 20:18:30  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 64.0 | 90% | – | – |
| LangGraph | Node → StateGraph → Node | 224.3 | 85% | 3.7 | – |
| Hybrid | LC → LangGraph → LC | 115.7 | 88% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 57.0 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 187.7 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 114.0 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 69.5 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 195.4 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 135.2 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 58.1 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 195.3 | mistral | – | 3 | – |
| Hybrid | 4 | 4 / 4 | 100% | 58.6 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 69.8 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 222.7 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 161.4 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 79.5 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 185.9 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 110.6 | mistral | – | – | – |
...
```
Aufgabe 1: Löse die Gleichung: $3x + 7 = 17$
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 31.7 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 86.0 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 41.6 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 44.6 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 142.8 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 71.0 | tesseract | – | – | – |
...
| LangGraph | 6 | 4 / 5 | 80% | 249.0 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 119.7 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 54.3 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 167.2 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 83.6 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 57.9 | tesseract | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 185.8 | tesseract | – | 5 | – |
| Hybrid | 4 | 4 / 4 | 100% | 91.2 | tesseract | – | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 2 / 3 | 67% | 53.2 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 151.8 | tesseract | – | 3 | – |
| Hybrid | 4 | 2 / 3 | 67% | 129.1 | tesseract | – | – | – |

**PDF:** `income_statement.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 67.7 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 213.0 | tesseract | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 139.4 | tesseract | – | – | – |
...
| LangGraph | 5 | 1 / 4 | 25% | 317.4 | tesseract | – | 4 | – |
| Hybrid | 5 | 2 / 4 | 50% | 164.3 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 72.2 | tesseract | – | – | – |
| LangGraph | 6 | 3 / 5 | 60% | 554.6 | tesseract | – | 9 | – |
| Hybrid | 6 | 4 / 4 | 100% | 142.4 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 87.1 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 310.0 | tesseract | – | 4 | – |
| Hybrid | 6 | 4 / 5 | 80% | 172.8 | tesseract | – | – | – |
...
```
Unternehmen: NovaTech Ltd.  
Bilanz zum 31.12.2024:

**AKTIVA**

- Anlagevermögen: 210 000 NOK  
- Umlaufvermögen: 140 000 NOK  

Summe: 350 000 NOK  

**PASSIVA**

- Eigenkapitalanteil: 200 000 NOK  
- Verbindlichkeiten: 150 000 NOK  
...
```
Die NovaTech GmbH weist ein Eigenkapital von 1,300,000 CHF und ein Gesamtvermögen von 4,200,000 CHF aus. Ermitteln Sie den Eigenkapitalanteil am Gesamtvermögen.
```

> **Issues:** Semantische Ähnlichkeit zu gering (Wirtschaft): BERTScore 0.701 < 0.72 | Länge weicht stark ab: 160 vs 42 Zeichen (Ratio: 3.81, erlaubt: 0.3–3.5)
</details>
...
```
Der Jahreserlös der NordTech GmbH betrug 680.000 CHF, die Betriebsausgaben lagen bei 610.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der Nordsee GmbH betrug 720.000 CHF, die Betriebsausgaben beliefen sich auf 660.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
- **LangGraph** / languages / Seg 2 / V1: Ratio 10.9×
- **LangChain** / economics / Seg 3 / V1: Ratio 3.8×
- **LangChain** / economics / Seg 3 / V1: Ratio 3.2×
- **LangGraph** / economics / Seg 3 / V1: Ratio 3.3×
- **LangGraph** / economics / Seg 4 / V1: Ratio 3.4×
- **Hybrid** / economics / Seg 4 / V1: Ratio 3.1×
- **LangChain** / economics / Seg 3 / V1: Ratio 5.5×
- **LangChain** / economics / Seg 4 / V1: Ratio 6.3×
- **LangGraph** / economics / Seg 3 / V1: Ratio 5.4×
- **LangGraph** / economics / Seg 4 / V1: Ratio 4.9×
- **LangGraph** / economics / Seg 5 / V1: Ratio 3.8×
- **Hybrid** / economics / Seg 3 / V1: Ratio 3.4×
- **Hybrid** / economics / Seg 4 / V1: Ratio 4.7×
- **Hybrid** / economics / Seg 5 / V1: Ratio 3.3×
