...
**Datum:** 2026-04-21 20:38:52  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 67.1 | 86% | – | – |
| LangGraph | Node → StateGraph → Node | 216.1 | 89% | 3.6 | – |
| Hybrid | LC → LangGraph → LC | 114.3 | 89% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 66.5 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 198.6 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 112.8 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 69.2 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 211.5 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 170.2 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 68.2 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 195.5 | mistral | – | 3 | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 77.1 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 209.6 | mistral | – | 3 | – |
| Hybrid | 6 | 4 / 5 | 80% | 140.1 | mistral | – | – | – |

**PDF:** `percentage_ratio.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 78.2 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 215.2 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 135.4 | mistral | – | – | – |
...
```
Aufgabe 2: Vereinfache: $5(a + 3) - 1(a - 2)$
```
</details>
...
```
Aufgabe 2: Vereinfache: $5(a+4)\;-\;3(a-2)$
```
</details>
...
```
Aufgabe 2: Vereinfache: $5(a+4)\;-\;5\bigl(a-3\bigr)$
```
</details>
...
```
Aufgabe 4: Ein Betrag von 1 300 € wird zu 4 % Zinsen angelegt.  
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 35.4 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 90.3 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 48.3 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 53.1 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 140.8 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 72.6 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 98.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 224.8 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 118.8 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 61.3 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 158.1 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 95.1 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 4 | 75% | 50.0 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 151.7 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 96.9 | tesseract | – | – | – |
...
__ Turm ragt über __ Plateau.
__ Vögel nisten in __ Wald.
```
</details>
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 47.4 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 154.8 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 86.9 | tesseract | – | – | – |

**PDF:** `income_statement.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 2 / 4 | 50% | 72.9 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 323.7 | tesseract | – | 6 | – |
| Hybrid | – | – | – | – | – | – | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 61.2 | tesseract | – | – | – |
| LangGraph | 5 | 1 / 4 | 25% | 270.2 | tesseract | – | 4 | – |
| Hybrid | 5 | 1 / 4 | 25% | 155.5 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 75.8 | tesseract | – | – | – |
| LangGraph | 6 | 3 / 5 | 60% | 481.0 | tesseract | – | 8 | – |
| Hybrid | 6 | 4 / 5 | 80% | 183.6 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 92.7 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 216.1 | tesseract | – | 3 | – |
| Hybrid | – | – | – | – | – | – | – | – |
...
- Eigenkapitalanteil: 174.000 CHF  
- Fremdkapitalquote: 144.000 CHF  
...
```
Ermittle den Eigenkapitalanteil, wenn das Eigenkapital 350 000 CHF und das Gesamtkapital 1 200 000 CHF beträgt.
```
</details>
...
```
Ermittle den Eigenkapitalanteil, wenn das Gesamtkapital einer fiktiven Firma 1 200 000 CHF beträgt und das Eigenkapital 360 000 CHF ist.
```
</details>
...
```
Der Jahreserlös der NordicTech GmbH betrug 720.000 CHF, die Betriebsausgaben lagen bei 600.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der Nordwind GmbH betrug 770.000 CHF, die Betriebsausgaben lagen bei 310.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Aufgabe 2: Der Umsatz betrug 680 000 € und die Kosten 310 000 €.  
Wie hoch ist der Gewinn?
```
</details>
...
- **LangChain** / economics / Seg 4 / V1: Ratio 3.9×
- **LangGraph** / economics / Seg 3 / V1: Ratio 4.8×
- **LangGraph** / economics / Seg 4 / V1: Ratio 3.8×
- **LangGraph** / economics / Seg 5 / V1: Ratio 3.6×
- **Hybrid** / economics / Seg 3 / V1: Ratio 3.2×
- **Hybrid** / economics / Seg 4 / V1: Ratio 4.1×
- **Hybrid** / economics / Seg 5 / V1: Ratio 3.6×
