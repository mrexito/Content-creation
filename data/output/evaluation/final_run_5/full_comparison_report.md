...
**Datum:** 2026-04-20 19:57:39  |  **Varianten/Segment:** 1  |  **Frameworks:** 3  |  **Domains:** 3
...
|-----------|-------------|------------|--------------------|-----------|-------------|
| LangChain | Chain → Chain → Chain | 63.5 | 79% | – | – |
| LangGraph | Node → StateGraph → Node | 190.5 | 91% | 2.9 | – |
| Hybrid | LC → LangGraph → LC | 121.1 | 89% | – | – |
...
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 64.7 | mistral | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 193.0 | mistral | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 100.0 | mistral | – | – | – |

**PDF:** `equations_advanced.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 56.9 | mistral | – | – | – |
| LangGraph | 5 | 3 / 4 | 75% | 191.7 | mistral | – | 3 | – |
| Hybrid | 5 | 3 / 4 | 75% | 122.9 | mistral | – | – | – |

**PDF:** `word_problems.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 4 / 4 | 100% | 64.9 | mistral | – | – | – |
| LangGraph | 4 | 4 / 4 | 100% | 62.3 | mistral | – | 0 | – |
| Hybrid | 4 | 4 / 4 | 100% | 61.1 | mistral | – | – | – |

**PDF:** `geometry_area.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 65.6 | mistral | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 221.6 | mistral | – | 3 | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 4 / 5 | 80% | 73.7 | mistral | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 201.2 | mistral | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 124.4 | mistral | – | – | – |
...
```
Aufgabe 4: Ein Kapital von 1 300 € wird zu 4 % Zinsen angelegt.  
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 3 | 100% | 36.6 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 81.8 | tesseract | – | 3 | – |
| Hybrid | 4 | 3 / 3 | 100% | 46.8 | tesseract | – | – | – |

**PDF:** `sentence_construction.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 5 / 5 | 100% | 49.7 | tesseract | – | – | – |
| LangGraph | 6 | 5 / 5 | 100% | 144.4 | tesseract | – | 3 | – |
| Hybrid | 6 | 5 / 5 | 100% | 74.5 | tesseract | – | – | – |

**PDF:** `verb_conjugation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 4 / 4 | 100% | 75.1 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 210.1 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 113.9 | tesseract | – | – | – |

**PDF:** `text_transformation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 53.9 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 154.7 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 97.5 | tesseract | – | – | – |

**PDF:** `word_forms.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 3 / 4 | 75% | 66.1 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 149.4 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 83.7 | tesseract | – | – | – |
...
| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 4 | 1 / 3 | 33% | 48.9 | tesseract | – | – | – |
| LangGraph | 4 | 3 / 3 | 100% | 158.3 | tesseract | – | 3 | – |
| Hybrid | 4 | 2 / 2 | 100% | 94.4 | tesseract | – | – | – |

**PDF:** `income_statement.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 63.2 | tesseract | – | – | – |
| LangGraph | 5 | 4 / 4 | 100% | 213.3 | tesseract | – | 3 | – |
| Hybrid | 5 | 4 / 4 | 100% | 216.7 | tesseract | – | – | – |

**PDF:** `investment_calculation.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 5 | 3 / 4 | 75% | 70.2 | tesseract | – | – | – |
| LangGraph | 5 | 2 / 4 | 50% | 234.4 | tesseract | – | 3 | – |
| Hybrid | 5 | 1 / 3 | 33% | 170.6 | tesseract | – | – | – |

**PDF:** `cost_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 71.5 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 347.7 | tesseract | – | 4 | – |
| Hybrid | 6 | 4 / 5 | 80% | 149.2 | tesseract | – | – | – |

**PDF:** `market_analysis.pdf`

| Framework | Segmente | Valide / Total | Rate | Zeit (s) | OCR | Tool-Calls | Retries | Halluziniert |
|-----------|----------|----------------|------|----------|-----|------------|---------|--------------|
| LangChain | 6 | 3 / 5 | 60% | 90.7 | tesseract | – | – | – |
| LangGraph | 6 | 4 / 5 | 80% | 293.7 | tesseract | – | 4 | – |
| Hybrid | 6 | 3 / 5 | 60% | 212.2 | tesseract | – | – | – |
...
```
Bestimme den Eigenkapitalanteil, wenn das Eigenkapital 1 300 000 CHF und das Gesamtkapital 4 500 000 CHF beträgt.
```
</details>
...
```
Der Jahreserlös der NordTech AG betrug 720.000 CHF und die Betriebsausgaben beliefen sich auf 630.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
```
Der Jahreserlös der NovaTech AG betrug 682.000 CHF, die Betriebsausgaben lagen bei 618.000 CHF. Wie hoch ist der Jahresüberschuss?
```
</details>
...
- **LangGraph** / economics / Seg 5 / V1: Ratio 4.2×
